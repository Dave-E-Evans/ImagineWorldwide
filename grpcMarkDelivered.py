...
async def main(grpc_host, grpc_port, client_id, destination_id, file_list):
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1 or len(sys.argv) % 2 == 0:
        print('Usage: python3 grpcMarkDelivered.py <file_id_1> <file_name_1> ...')
        exit(1)
    ...
    asyncio.run(main(grpc_host=grpc_host, grpc_port=grpc_port, client_id=client_id, destination_id=destination_id, file_list=file_list))